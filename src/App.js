...
const Node = ({ title, content, icon: Icon, type = 'normal', width = 'w-[380px]' }) => {
  ...
  return (
    <div className={`relative flex flex-col ${width} flex-shrink-0 rounded-[48px] border-[6px] transition-all hover:scale-105 ${themes[type]}`}>
      <div className={`px-8 py-6 text-[24px] font-black uppercase tracking-tight flex items-center gap-4 rounded-t-[42px] border-b-[6px] border-inherit ${
      ...
      <div className="p-10 text-[20px] font-black leading-snug min-h-[160px] flex items-center justify-center text-center break-words">
        {content}
      </div>
    </div>
  );
...
// --- フローティング・リモコン（ラインのどこにいても操作できるスライダー） ---
const FloatingScrollController = ({ containerRef }) => {
  ...
  return (
    <div className="fixed bottom-10 right-10 z-[100] bg-[#2D2D2D]/90 backdrop-blur-md p-8 rounded-[40px] shadow-2xl border-4 border-[#E67E22] flex items-center gap-8 animate-in slide-in-from-bottom-10">
      <div className="bg-[#E67E22] p-4 rounded-full text-white shadow-lg">
        <Sliders size={28} strokeWidth={3} />
      </div>
      <div className="flex flex-col gap-2 min-w-[300px]">
        <div className="flex justify-between items-center text-white font-black text-sm tracking-widest uppercase opacity-70">
           <span>Start</span>
    ...
    <div className="min-h-screen bg-[#FAF9F6] font-sans text-[#423D37] selection:bg-[#E67E22]/10 overflow-x-hidden">
      <header className="bg-[#2D2D2D] text-white shadow-2xl sticky top-0 z-50 border-b-[15px] border-[#E67E22]">
        <div className="max-w-[3200px] mx-auto px-16 py-12 flex flex-col xl:flex-row justify-between items-center gap-12">
          <div className="flex items-center gap-12 group cursor-default">
            ...
            <div>
              <h1 className="text-[80px] font-black tracking-tighter leading-none">AI MECHANISM <span className="text-[#FACC15]">EXPLAINER</span></h1>
          ...
          <nav className="flex bg-white/5 backdrop-blur-xl p-8 rounded-[100px] border border-white/10 shadow-inner">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-10 px-18 py-12 rounded-[80px] text-4xl font-black transition-all duration-500 ${
                  activeTab === tab.id 
      ...
      <main className="animate-in fade-in zoom-in-95 duration-1000">
          ...
          <div ref={scrollContainerRef} className="w-full overflow-x-auto scrollbar-premium touch-pan-x bg-[#FAF9F6] pb-32 overscroll-none">
            <div className="p-20 inline-block min-w-max">
              <div className="flex flex-col gap-32">
                <h1 className="text-8xl font-black text-[#423D37] flex items-center gap-10 tracking-tighter drop-shadow-lg leading-none">
                   <ChefHat className="text-[#E67E22]" size={110} strokeWidth={3} /> ＜AIレストラン＞
                </h1>
                
                <div className="flex flex-col gap-10">
                  <div className="ml-16 inline-block self-start bg-[#8A9A5B] text-white px-14 py-5 rounded-full font-black text-5xl shadow-xl">通常搬送ライン</div>
                  <ContinuousConveyor>
                    ...
                    <div className="flex flex-col gap-10 items-center relative flex-shrink-0">
                      ...
                      <Node title="材料調達方法" content={<span>AI材料倉庫<br/><span className="text-xl opacity-80 mt-2 block">学習データ/文脈/ログ/メモリ</span></span>} icon={Database} width="w-[450px]" />
                    </div>
                  </ContinuousConveyor>
                </div>

                <div className="flex flex-col gap-10">
                  <div className="ml-16 inline-block self-start bg-[#FACC15] text-[#5C4010] px-14 py-5 rounded-full font-black text-5xl shadow-xl border-4 border-white animate-pulse">イレギュラーライン</div>
                  <ContinuousConveyor isIrregular>
                    ...
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute -top-48 left-1/2 -translate-x-1/2 bg-[#FACC15] text-[#5C4010] px-12 py-6 rounded-full font-black text-[32px] shadow-[0_30px_60px_rgba(250,204,21,0.5)] animate-bounce flex items-center gap-6 border-[12px] border-white whitespace-nowrap z-50">
        ...
        {(activeTab === 'basic' || activeTab === 'external') && (
          <div ref={scrollContainerRef} className="w-full overflow-x-auto scrollbar-premium touch-pan-x bg-[#FAF9F6] pb-32 overscroll-none">
            <div className="p-20 inline-block min-w-max">
              <h2 className="text-8xl font-black text-[#423D37] flex items-center gap-10 mb-28 tracking-tighter drop-shadow-lg leading-none">
                <Settings className="text-[#8A9A5B] animate-spin-slow" size={110} /> ＜AI生産工場（{activeTab === 'basic' ? '通常ライン' : '外部調達ライン'}）＞
              </h2>
              <div className="flex flex-col gap-40">
                <div className="flex flex-col gap-10">
                  <div className="ml-16 inline-block self-start bg-[#8A9A5B] text-white px-14 py-5 rounded-full font-black text-5xl shadow-xl">通常ライン</div>
                  <ContinuousConveyor>
                    <Node title="レストラン発注" content="発注書" type="header" width="w-[320px]" />
                    <ArrowRight className="text-[#D6D1C7] flex-shrink-0" size={80} strokeWidth={4} />
                    <div className="flex flex-col gap-10 items-center flex-shrink-0">
                      <Node title="材料調達方法" content={<span>AI材料倉庫<br/><span className="text-lg opacity-70 mt-2 block">学習データ/文脈/ログ/メモリ</span></span>} icon={Database} width="w-[450px]" />
                      {activeTab === 'external' && (
                        <>
                    ...
                    <div className="flex flex-col items-center flex-shrink-0">
                      <FinishAnimation />
                      <Node title="仕上げ（温度調整）" content={<div className="text-left text-lg font-black leading-relaxed">ユーザーの嗜好に合わせて仕上げ<br/>・基本 / 冷製 / 温製 / シェフ特製</div>} width="w-[420px]" />
                    </div>
                    <ArrowRight className="text-[#D6D1C7] flex-shrink-0" size={80} strokeWidth={4} />
                ...
                <div className="flex flex-col gap-10">
                  <div className="ml-16 inline-block self-start bg-[#FACC15] text-[#5C4010] px-14 py-5 rounded-full font-black text-5xl shadow-xl border-6 border-white animate-pulse">イレギュラーライン</div>
                  <ContinuousConveyor isIrregular>
                    ...
                    <div className="flex flex-col gap-10 relative items-center flex-shrink-0">
                       <div className="absolute -top-40 bg-[#FACC15] text-[#5C4010] text-[28px] font-black px-16 py-8 rounded-full shadow-[0_30px_60px_rgba(250,204,21,0.4)] border-[10px] border-white whitespace-nowrap z-50 animate-pulse">
                         材料不足 ＋ オーダーのズレ
                       </div>
                       <Node title="材料調達方法" content={<span>AI材料倉庫<br/><span className="text-lg opacity-70 mt-2 block">学習データ/文脈/ログ/メモリ</span></span>} icon={Database} type="alert" width="w-[450px]" />
                       {activeTab === 'external' && (
                         <>
                    ...
                    <div className="relative group flex items-center min-w-max ml-32 flex-shrink-0">
                      <div className="absolute -top-60 left-1/2 -translate-x-1/2 bg-[#D9534F] text-white px-16 py-8 rounded-full font-black text-[42px] shadow-[0_40px_80px_rgba(217,83,79,0.7)] animate-bounce border-[15px] border-white z-50 whitespace-nowrap">
